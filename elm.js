...
var _Http_toTask = F3(function(router, toTask, request)
{
	return _Scheduler_binding(function(callback)
	{
		...
		try {
			xhr.open(request.h, request.aN, true);
		} catch (e) {
			return done(elm$http$Http$BadUrl_(request.aN));
		}
...
var elm$http$Http$request = function (r) {
	return elm$http$Http$command(
		elm$http$Http$Request(
			{v: false, at: r.at, aw: r.aw, e: r.e, h: r.h, i: r.i, j: r.j, aN: r.aN}));
};
var elm$http$Http$get = function (r) {
	return elm$http$Http$request(
		{at: elm$http$Http$emptyBody, aw: r.aw, e: _List_Nil, h: 'GET', i: elm$core$Maybe$Nothing, j: elm$core$Maybe$Nothing, aN: r.aN});
};
		...
		elm$http$Http$get(
			{
				...
				aN: 'https://raw.githubusercontent.com/lambda-study-group/lambdinha-bot/master/jokes.json'
			}));
};
	...
	return A2(
		...
		_List_fromArray(
			[
							...
							[
								...
								_List_fromArray(
									[
										...
										_List_fromArray(
											[
												elm$html$Html$text('(λstudy.group)')
											]))
									]))
							]))
					])),
				...
				switch (model.$) {
					case 0:
						return elm$html$Html$text('Meu pensamento não funcinou');
					case 1:
						return elm$html$Html$text('Pensando numa piada...');
					default:
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								elm$html$Html$text('Sejem bem vindos ao lambda study group!')
							])),
						A2(
						elm$html$Html$img,
						_List_fromArray(
						...
						_List_fromArray(
							[
								elm$html$Html$text('Nosso grupão mais top e funcional do '),
								A2(
								elm$html$Html$a,
								_List_fromArray(
									[
